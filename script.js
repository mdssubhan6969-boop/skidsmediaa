...
const translations = {
    en: {
        ...
        cat_contracting: "Interior Architecture & Contracting",
        p7_title: "Cephill Tours and Travel",
        p7_desc: "A complete travel and tourism platform for exploring new destinations.",
        p8_title: "Smart Zone Contracting",
        p8_desc: "Turnkey high-end interior architecture, bespoke spatial engineering, and contract coordination.",
        p9_title: "Sharjah Tamil Driving Instructor",
        p9_desc: "Professional driving instruction services tailored for Tamil speakers in Sharjah.",
        cat_legal: "Legal Services",
        p10_title: "GenZ Legals",
        p10_desc: "Modern legal services and consultancy tailored for the new generation.",
    ...
    ur: {
        ...
        cat_travel: "سفر اور سیاحت",
        cat_contracting: "انٹیریئر آرکیٹیکچر اور کنٹریکٹنگ",
        p7_title: "سیفیل ٹورز اینڈ ٹریول",
        p7_desc: "نئے مقامات کو تلاش کرنے کے لیے ایک مکمل سفر اور سیاحت کا پلیٹ فارم۔",
        p8_title: "سمارٹ زون کنٹریکٹنگ",
        p8_desc: "ٹرنکی ہائی اینڈ انٹیریئر آرکیٹیکچر، حسب ضرورت سپیشل انجینئرنگ، اور کنٹریکٹ کوآرڈینیشن۔",
        p9_title: "شارجہ تمل ڈرائیونگ انسٹرکٹر",
        p9_desc: "شارجہ میں تمل بولنے والوں کے لیے پیشہ ورانہ ڈرائیونگ انسٹرکشن سروسز۔",
        cat_legal: "قانونی خدمات",
        p10_title: "جن زی لیگلز",
        p10_desc: "نئی نسل کے لیے موزوں جدید قانونی خدمات اور مشاورت۔",
    ...
    ar: {
        ...
        cat_contracting: "الهندسة المعمارية الداخلية والمقاولات",
        p7_title: "سيفيل للسياحة والسفر",
        p7_desc: "منصة كاملة للسفر والسياحة لاستكشاف وجهات جديدة.",
        p8_title: "سمارت زون للمقاولات",
        p8_desc: "هندسة معمارية داخلية راقية تسليم مفتاح، وهندسة مساحية مخصصة، وتنسيق العقود.",
        p9_title: "مدرب قيادة تاميل الشارقة",
        p9_desc: "خدمات تعليم قيادة احترافية مخصصة للمتحدثين باللغة التاميلية في الشارقة.",
        cat_legal: "الخدمات القانونية",
        p10_title: "جين زي ليجالز",
        p10_desc: "خدمات قانونية واستشارات حديثة مصممة خصيصًا للجيل الجديد.",
    ...
    hi: {
        ...
        cat_travel: "यात्रा और पर्यटन",
        cat_contracting: "इंटीरियर आर्किटेक्चर और कॉन्ट्रैक्टिंग",
        p7_title: "सेफिल टूर्स एंड ट्रेवल्स",
        p7_desc: "नए गंतव्यों की खोज के लिए एक संपूर्ण यात्रा और पर्यटन मंच।",
        p8_title: "स्मार्ट ज़ोन कॉन्ट्रैक्टिंग",
        p8_desc: "टर्नकी हाई-एंड इंटीरियर आर्किटेक्चर, कस्टमाइज्ड स्पेशियल इंजीनियरिंग, और कॉन्ट्रैक्ट कोऑर्डिनेशन।",
        p9_title: "शारजाह तमिल ड्राइविंग इंस्ट्रक्टर",
        p9_desc: "शारजाह में तमिल भाषियों के लिए व्यावसायिक ड्राइविंग निर्देश सेवाएं।",
        cat_legal: "कानूनी सेवाएं",
        p10_title: "जेनजी लीगल्स",
        p10_desc: "नई पीढ़ी के लिए तैयार आधुनिक कानूनी सेवाएं और परामर्श।",
